...
namespace modular {
     ...
     */
    std::vector<int32_t> subtract(const std::vector<int32_t> &p, const std::vector<int32_t> &q) {
     ...
     */
    std::vector<int32_t> multiply(const std::vector<int32_t> &p, const std::vector<int32_t> &q) {
     ...
     * @return The result of multiplying p by q.
     */
    std::vector<int32_t> multiply_foil(const std::vector<int32_t> &p, const std::vector<int32_t> &q) {
     ...
     */
    std::vector<int32_t> divide(std::vector<int32_t> p, std::vector<int32_t> q) {
     ...
     */
    std::vector<int32_t> cyclotomic_polynomial(uint32_t N) {
